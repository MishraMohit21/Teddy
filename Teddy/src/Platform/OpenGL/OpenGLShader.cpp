...
namespace Teddy {
		...
		: m_FilePath(filepath)
	{
...

		{
			...
			CreateProgram();
			TD_CORE_WARN("Shader creation took {0} ms", timer.ElapsedMillis());
		}
	...
	void OpenGLShader::CreateProgram()
	{
		...
		if (isLinked == GL_FALSE)
		{
			...
			TD_CORE_ERROR("Shader linking failed ({0}):\n{1}", m_FilePath, infoLog.data());
